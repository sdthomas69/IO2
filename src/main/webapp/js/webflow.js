	 ...
	 */
        window.tram = function (a) {
            ...
            var k = function (a, b, c) {
                ...
                }, n = document, o = window, p = "bkwld-tram", q = /[\-\.0-9]/g, r = /[A-Z]/, s = "number", t = /^(rgb|#)/,
                u = /(em|cm|mm|in|pt|pc|px)$/, v = /(em|cm|mm|in|pt|pc|px|%)$/, w = /(deg|rad|turn)$/, x = "unitless",
                y = /(all|none) 0s ease 0s/, z = /^(width|height)$/, A = " ", B = n.createElement("a"),
                C = ["Webkit", "Moz", "O", "ms"], D = ["-webkit-", "-moz-", "-o-", "-ms-"], E = function (a) {
...
Webflow.require('ix').init([
    ...
    {
        "slug": "rollover-reveal",
        "name": "Rollover Reveal",
        "value": {
            "style": {"display": "block"},
            "triggers": [{
                "type": "hover",
                "selector": ".story-list-text",
                "descend": true,
                "stepsA": [{"display": "block", "opacity": 1, "transition": "opacity 500ms ease 0ms"}],
                "stepsB": [{"display": "block", "opacity": 0, "transition": "opacity 500ms ease 0ms"}]
            }]
        }
    },
    {
        "slug": "sidebar-rollover-category",
        "name": "Sidebar Rollover Category",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
                "selector": ".sidebar-menu-nav-category",
                "stepsA": [{"display": "block", "height": "0px", "wait": 0}, {
                    "opacity": 1,
                    "height": "auto",
                ...
                "stepsB": [{
                    "opacity": 0,
                    "height": "0px",
                    "transition": "opacity 100ms ease 0ms, height 500ms ease 0ms"
                }, {"display": "none"}]
            }]
        }
    },
    {
        "slug": "sidebar-rollover-research",
        "name": "Sidebar Rollover Research",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
                "selector": ".sidebar-menu-nav-research",
                "stepsA": [{"display": "block", "height": "0px", "wait": 0}, {
                    "opacity": 1,
                    "height": "auto",
                    "transition": "opacity 400ms ease 0ms, height 500ms ease 0ms"
    ...
    {
        "slug": "sidebar-rollover-admin",
        "name": "Sidebar Rollover Admin",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
                "selector": ".sidebar-menu-nav-admin",
                "stepsA": [{"display": "block", "height": "0px", "wait": 0}, {
                    "opacity": 1,
                    "height": "auto",
                    "transition": "opacity 400ms ease 0ms, height 500ms ease 0ms"
    ...
    {
        "slug": "sidebar-rollover-download",
        "name": "Sidebar Rollover Download",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
                "selector": ".sidebar-menu-nav-download",
                "stepsA": [{"display": "block", "height": "0px", "wait": 0}, {
                    "opacity": 1,
                    "height": "auto",
                    "transition": "opacity 400ms ease 0ms, height 500ms ease 0ms"
    ...
    {
        "slug": "sidebar-onload-hide",
        "name": "Sidebar Onload Hide",
        "value": {"style": {"display": "none"}, "triggers": []}
    },
    {
        "slug": "rollover-reveal-2",
        "name": "Rollover Reveal 2",
        "value": {
            "style": {"display": "block"},
            "triggers": [{
                "type": "hover",
                "selector": ".spotlight-text-block",
                "descend": true,
                "stepsA": [{"display": "block", "opacity": 1, "transition": "opacity 500ms ease 0ms"}],
                "stepsB": [{"display": "block", "opacity": 0, "transition": "opacity 500ms ease 0ms"}]
            }]
    ...
    {"slug": "display-none", "name": "Display None", "value": {"style": {"display": "none"}, "triggers": []}},
    {
        ...
        "value": {
            ...
            "triggers": [{
                ...
                "stepsA": [{"display": "none", "opacity": 0, "transition": "opacity 500ms ease 0ms"}],
                "stepsB": [{
                    "display": "block",
                    "opacity": 1,
                    "wait": 500,
    ...
    {
        "slug": "on-load-move-left",
        "name": "On Load Move Left",
        "value": {
            "style": {"opacity": 0, "x": "-20px", "y": "0px", "z": "0px"},
            "triggers": [{
                "type": "load",
                "stepsA": [{"wait": 300}, {
                    "opacity": 1,
    ...
    {
        "slug": "on-load-move-left-2",
        "name": "On Load Move Left 2",
        "value": {
            "style": {"opacity": 0, "x": "20px", "y": "0px", "z": "0px"},
            "triggers": [{
                "type": "load",
