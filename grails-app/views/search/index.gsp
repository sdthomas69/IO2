...
<div class="grid_16">
    <table align="left">
        <tr>
            <td>
                <g:form url='[controller: params.object, action: ' search']' id="searchableForm" name="searchableForm"
                        method="get">
    ...
    <div id="content" class="container_16">
        <div id="smallThumbs160" class="grid_16">
            ...
            <g:each var="result" in="${searchResult}" status="i">
                ...
                <div class='<blackFish:setClass counter="${i}" width="8" beginDiv="grid_2 alpha" middleDiv="grid_2"
                                                endDiv="grid_2 omega"/>'>

                    <g:if test="${className == 'File'}">
                        <g:link controller="file" action="title" params="['title': result]"><img class="imageborder"
                                                                                                 src="<g:resource
                                                                                                         file='${result.smallImage}'/>"
                                                                                                 alt="" width="98"
                                                                                                 border="0"/></g:link>
                        <g:link controller="file" action="title" params="['title': result]"><p
                                class="imagecaption">${result}</p></g:link>
                    </g:if>

                    <g:elseif test="${className == 'Event'}">
                        <g:link controller="event" action="title" params="['title': result]"><p
                                class="imagecaption">${result}</p></g:link>
                    </g:elseif>

                    <g:elseif test="${className == 'Story'}">
                        <g:link controller="story" action="title" params="['title': result]"><img class="imageborder"
                                                                                                  src="<g:resource
                                                                                                          file='${result?.primaryImage?.smallImage ?: thumbnail}'/>"
                                                                                                  alt="" width="98"
                                                                                                  border="0"/></g:link>
                        <g:link controller="story" action="title" params="['title': result]"><p
                                class="imagecaption">${result}</p></g:link>
                    </g:elseif>
