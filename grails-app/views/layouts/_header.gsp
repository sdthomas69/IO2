...
<%--			<g:link class="member-portal utilities-text-link" uri="/story/Contact">Contact</g:link>--%>
			...
			<a class="modal-link w-inline-block" href="#">
				<img class="modal-link searchbutton" src="<g:resource dir='images' file='search-icon-white.png' />" width="27" search="Search"> 
			</a>
...
<%-- Main Menu --%>
<div class="navigationbar w-nav" data-animation="over-right" data-collapse="medium" data-contain="1" data-duration="400" data-ix="display-nav">
	<div class="w-container">
