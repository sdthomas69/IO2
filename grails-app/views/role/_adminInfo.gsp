		...
		<div class="w-container admin-container">
			<ul class="w-list-unstyled w-clearfix admin-nav-bar-list">
				<g:if test="${roleInstance?.id}">
					<shiro:hasPermission permission="role:edit:${roleInstance.id}">
						<li class="admin-nav-bar-list-item">
							<g:link class="w-inline-block admin-link edit-button" action="edit" controller="role" id="${roleInstance.id}"> 
				...
				<shiro:hasPermission permission="role:index">
					<li class="admin-nav-bar-list-item">
						<g:link class="w-inline-block admin-link" controller="role" action="index">
							<img class="icon-admin-menu" src="<g:resource dir='images' file='storylist-white.png' />" height="35">
							<div class="admin-link-text-block">Role List</div>
						</g:link>
					</li>
				</shiro:hasPermission>
				<shiro:hasPermission permission="role:create">
					<li class="admin-nav-bar-list-item">
						<g:link class="w-inline-block admin-link" action="create" controller="role">
							<img class="icon-admin-menu" src="<g:resource dir='images' file='addstory-white.png' />" height="35">
							<div class="admin-link-text-block">New Role</div>
						</g:link>
					</li>
				</shiro:hasPermission>
