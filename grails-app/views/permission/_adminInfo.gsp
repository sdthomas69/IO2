	...
	<div class="w-section admin-section">
		<div class="w-container admin-container">
			<ul class="w-list-unstyled w-clearfix admin-nav-bar-list">
				<g:if test="${permissionInstance?.id}">
					<shiro:hasPermission permission="permission:edit:${permissionInstance.id}">
						<li class="admin-nav-bar-list-item">
							<g:link class="w-inline-block admin-link edit-button" action="edit" controller="permission" id="${permissionInstance.id}"> 
				...
				<shiro:hasPermission permission="permission:list">
					<li class="admin-nav-bar-list-item">
						<g:link class="w-inline-block admin-link" controller="permission" action="list">
							<img class="icon-admin-menu" src="<g:resource dir='images' file='storylist-white.png' />" height="35">
							<div class="admin-link-text-block">Permission List</div>
						</g:link>
					</li>
				</shiro:hasPermission>
				<shiro:hasPermission permission="permission:create">
					<li class="admin-nav-bar-list-item">
						<g:link class="w-inline-block admin-link" action="create" controller="permission">
							<img class="icon-admin-menu" src="<g:resource dir='images' file='addstory-white.png' />" height="35">
							<div class="admin-link-text-block">New Permission</div>
						</g:link>
					</li>
				</shiro:hasPermission>
