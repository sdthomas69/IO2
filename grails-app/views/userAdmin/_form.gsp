...
<div class="w-row">
	<div class="w-col w-col-6 field-col">
		...
		<input type="text" id="username" name="username" class="w-input" value="${fieldValue(bean:userInstance,field:'username')}"/>
	</div>
	<%--<div class="w-col w-col-6 field-col">
...
<div class="w-row">
	<div class="w-col w-col-6 field-col">
		...
		<input type="text" id="firstName" name="firstName" class="w-input" value="${fieldValue(bean:userInstance,field:'firstName')}"/>
	</div>
	<div class="w-col w-col-6 field-col">
		<label for="field" class="field-label">Last Name</label>
		<input type="text" id="lastName" name="lastName" class="w-input" value="${fieldValue(bean:userInstance,field:'lastName')}"/>
	</div>
</div>
<div class="w-row">
	...
	<div class="w-col w-col-4 field-col">
		...
		<input type="text" id="email" name="email" class="w-input" value="${fieldValue(bean:userInstance,field:'email')}"/>
	</div>
	<div class="w-col w-col-4 field-col">
		<label for="field" class="field-label">Department</label>
		<input type="text" id="department" name="department" class="w-input" value="${fieldValue(bean:userInstance,field:'department')}"/>
	</div>
</div>
