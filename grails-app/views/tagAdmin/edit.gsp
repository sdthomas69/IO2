    ...
    <div class="w-container body-text-container primary-small contains-admin-nav-bar">
        ...
        <div class="w-tabs admin-text-tabs" data-duration-in="300" data-duration-out="100">
            ...
            <div class="w-tab-menu admin-tabs-menu-container">
                <a class="w-tab-link ${flash.tab == null ? 'w--current' : ''} w-inline-block tab-link-button"
                   data-w-tab="Tab 1">
                    <div>1. Title</div>
                </a>
                <a class="w-tab-link ${flash.tab == 'stories' ? 'w--current' : ''} w-inline-block tab-link-button"
                   data-w-tab="Tab 2">
                    <div>2. Stories</div>
                </a>
                <a class="w-tab-link ${flash.tab == 'files' ? 'w--current' : ''} w-inline-block tab-link-button"
                   data-w-tab="Tab 3">
                    <div>3. Files</div>
                </a>
                <a class="w-tab-link ${flash.tab == 'users' ? 'w--current' : ''} w-inline-block tab-link-button"
                   data-w-tab="Tab 4">
                    <div>4. People</div>
                </a>
            </div>
