                ...
                <g:if test="${helpInstance.primaryImage}">
                    <div class="col-filePrimary">
                        <g:link controller='file' action='show' id='${helpInstance.primaryImage.id}'>
                            <img class="imageborder" src="<g:resource file='${helpInstance.primaryImage.smallImage}'/>"
                                 alt="${helpInstance.primaryImage}" border="0"/>

                            <p><g:link params='["id": helpInstance.id]'
                                       action='unSetPrimaryImage'>(- Remove)</g:link></p>
                        </g:link>
                    </div>
                </g:if>
                <g:if test="${!helpInstance.primaryImage}">
