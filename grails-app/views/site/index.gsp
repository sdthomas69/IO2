        ...
        <div class="datagrid">
            <table>
                ...
                <tr>
                    ...
                    <g:sortableColumn property="styleSheet"
                                      title="${message(code: 'site.styleSheet.label', default: 'Style Sheet')}"/>
                ...
                <g:each in="${siteInstanceList}" status="i" var="siteInstance">
                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                        ...
                        <td><g:link action="edit"
                                    id="${siteInstance.id}">${fieldValue(bean: siteInstance, field: "title")}</g:link></td>
